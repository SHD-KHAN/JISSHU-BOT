...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-100183234079'))
...
URL = "https://jishan-khan.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://jishan-khan.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://jishan-khan.onrender.com/".format(FQDN)
else:
    URL = "https://jishan-khan.onrender.com/".format(FQDN)
